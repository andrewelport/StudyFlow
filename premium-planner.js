...
- ⚠️ קודם כול — בקשות המשתמש הן חוקים קשיחים, לא המלצות: כבד במלואם את userNote, chatTranscript, refine ו-blockedDays. אם המשתמש ביקש לא ללמוד ביום מסוים, פחות בערב, להדגיש/להפחית קורס, או כל אילוץ אחר — אסור לחרוג מזה. זה גובר על כל שיקול אופטימיזציה אחר.
